...
- [Revenue Loop](https://arcoventure.studio/lexicon/revenue-loop) — The Revenue Loop is the unit of analysis for TEA scoring: the axis measures the proportion of task volume within the loop that agents execute end-to-end without human initiation, completion, or review.
...
- [Lexicon](https://arcoventure.studio/lexicon/task-execution-autonomy) — canonical definition
- [Wiki](https://wiki.arcoventure.studio/lexicon/task-execution-autonomy) — extended entry
