...
- [Headcount Decoupling](https://arcoventure.studio/lexicon/headcount-decoupling) — Headcount Decoupling is the architectural condition that SHI measures: the separation of the critical path of execution from human capacity is what produces the expanding revenue-to-headcount curve that a score of 2 requires.
- [Human to Logic Ratio](https://arcoventure.studio/lexicon/human-to-logic-ratio) — The Human to Logic Ratio is the market-level measure that SHI applies to the business level: a score of 2 indicates that the logic layer, not human labour, is handling the majority of operational volume.
...
- [Lexicon](https://arcoventure.studio/lexicon/structural-headcount-independence) — canonical definition
- [Wiki](https://wiki.arcoventure.studio/lexicon/structural-headcount-independence) — extended entry
